...
while True:  # While loop that loops forever
    ...
    #dataArray[1] = '2'
    time.sleep(0.1)
    temp = random.random()#float(dataArray[0])  # Convert first element to floating number and put in temp
    P = random.random()#float(dataArray[1])  # Convert second element to floating number and put in P
    print("temp = "+str(temp))
    print("P = "+str(P))
