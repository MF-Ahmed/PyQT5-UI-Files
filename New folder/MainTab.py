...
class MyLCDNumber(QWidget):
    def __init__(self, posx,posy):
        super(MyLCDNumber, self).__init__()

        self.Gauge1Value = QLCDNumber(self)
        self.Gauge1Value.move(posx, posy)
        self.Gauge1Value.setMaximumHeight(100)
        self.Gauge1Value.setFixedWidth(60)
        self.Gauge1Value.setDigitCount(4)
        self.Gauge1Value.setStyleSheet('background - color: rgb(255, 236, 213);color: rgb(0, 0, 255)')
...
class MainTab(QWidget):
    ...
    def FirstTabInitUi(self):
        ...
        #self.handler = TimedRotatingFileHandler('log/PlantMessages.log', when="midnight", interval=1, encoding='utf8')
        ...
        self.SelectCOM.setFixedWidth(70)

        self.SelectBR = QComboBox(self.CommgroupBox)
        self.SelectBR.move(10+100, 40)
        ...
        self.CommSettings.move(200 , 17)
        self.CommSettings.setFixedWidth(150)
    ...
    def Press1Display(self):
        ...
        self.Gauge3Value.setGeometry(QRect(self.Pres1Posx, self.Pres1Posy + 30,
                                    self.LCDSetMaxWidth, self.LCDSetMaxHeight))
        self.Gauge3Value.setStyleSheet('border: 2px solid green;background-color: rgb(85, 255, 255);font: 29pt "MS Shell Dlg 2"; ')
    ...
    def Press2Display(self):
        ...
        self.Gauge4Value.setGeometry(QRect(self.Pres2Posx, self.Pres2Posy + 30,
                                    self.LCDSetMaxWidth, self.LCDSetMaxHeight))
        self.Gauge4Value.setStyleSheet('border: 2px solid green;background-color: rgb(85, 255, 255);font: 29pt "MS Shell Dlg 2"; ')
    ...
    def Temp1(self):
        ...
        for x, y in self.Temp1UPDLabels.items():
            ...
            y.setFixedWidth(self.LabelNSetMaxWidth)
            y.setAlignment(Qt.AlignCenter | Qt.AlignVCenter)
            y.setStyleSheet('border: 2px solid green;background-color: rgb(85, 255, 255);font: 8pt "MS Shell Dlg 2"; ')
            posyinc = posyinc+30
