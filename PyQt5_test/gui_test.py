...
class MainWindow(QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        button_action.hovered.connect(lambda: self.hovered(1))
        ...
        button2_action.hovered.connect(lambda: self.hovered(2))
    ...
    def hovered(self,button):
        print (f'You Hovered button {button}')
